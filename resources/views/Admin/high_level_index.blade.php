...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <form action="{{route('admin.highlevel.delall') }}" method="post"  accept-charset="UTF-8" >
                    ...
                    <div class="portlet box purple">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                ...
                                <a href="{{route('admin.highlevel.create')}}" class="btn green"><i class="icon-plus"></i>新增</a>
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><input type="checkbox"  name="ids[]"  value="{{ $highlevel->id}}"class="checkboxes" value="1" /></td>

                                    <td>{{$highlevel->high_name}}</td>

                                    <td>{{$highlevel->sort}}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin.highlevel.edit',$highlevel->id)}}"><span class="btn mini purple"  style="margin-left: 10px"><i class="icon-edit"></i> 编辑 </span></a>

                                    </td>

                                    <td>

                                       <a href="javascript:;" onclick="delLink({{$highlevel->id}})"  class="btn mini black""><i class="fa fa-trash-o"></i>删除 </a>
...
@section('page-js')
    ...
    <script type="text/javascript">
            ...
            layer.confirm('确定要执行删除操作吗？', {
                ...
                $.post("{{url('admin/highlevel/')}}/"+id,{'_method':'delete','_token':"{{csrf_token()}}"},function (data) {
